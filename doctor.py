...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/fenlei1/doctor.jpg"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(250, 480, 80, 40))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(250, 530, 80, 40))
        ...
        self.textBrowser.setGeometry(QtCore.QRect(240, 160, 130, 90))
        self.textBrowser.setObjectName("textBrowser")
        self.textBrowser.setStyleSheet("QTextBrowser{background: transparent}"
                                       "QTextBrowser{border-color:rgb(255,255,255);}"
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "问诊"))
