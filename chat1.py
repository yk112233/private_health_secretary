...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/fenlei1/chat.jpg"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(100, 470, 80, 40))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(100, 530, 80, 40))
        ...
        self.textBrowser.setGeometry(QtCore.QRect(90, 200, 130, 75))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "开始聊天"))
